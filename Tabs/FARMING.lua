...
-- ==================================================
-- FEATURE: AUTO TREADMILL
-- ==================================================
local TreadmillHolder = Instance.new("Frame")
TreadmillHolder.Size = UDim2.new(1, 0, 0, 52)
TreadmillHolder.BackgroundTransparency = 1
TreadmillHolder.LayoutOrder = 4
TreadmillHolder.Parent = FarmingPage

local TreadmillLabel = Instance.new("TextLabel")
TreadmillLabel.Size = UDim2.new(1, -50, 0, 20)
TreadmillLabel.Position = UDim2.new(0, 0, 0, 2)
TreadmillLabel.BackgroundTransparency = 1
TreadmillLabel.Text = "Auto Treadmill"
...
TreadmillLabel.Parent = TreadmillHolder

local TreadmillSub = Instance.new("TextLabel")
TreadmillSub.Size = UDim2.new(1, -50, 0, 18)
TreadmillSub.Position = UDim2.new(0, 0, 0, 24)
TreadmillSub.BackgroundTransparency = 1
TreadmillSub.Text = "Fly to your plot treadmill"
TreadmillSub.TextColor3 = Color3.fromRGB(150, 150, 170)
TreadmillSub.TextSize = 10
TreadmillSub.TextXAlignment = Enum.TextXAlignment.Left
TreadmillSub.Font = Enum.Font.Gotham
TreadmillSub.Parent = TreadmillHolder

local TreadmillButton = Instance.new("TextButton")
TreadmillButton.Size = UDim2.new(0, 26, 0, 26)
TreadmillButton.Position = UDim2.new(1, -26, 0.5, -13)
TreadmillButton.BackgroundColor3 = Color3.fromRGB(28, 29, 39)
TreadmillButton.BorderSizePixel = 0
TreadmillButton.Text = ""
TreadmillButton.AutoButtonColor = false
TreadmillButton.Parent = TreadmillHolder
...
TreadmillStroke.Color = Color3.fromRGB(200, 200, 220)
TreadmillStroke.Thickness = 1.5
TreadmillStroke.Parent = TreadmillButton
...
local function SetTreadmillUI(state)
    ...
    if state then
        ...
        TreadmillStroke.Color = Color3.fromRGB(135, 120, 225)
    else
        TreadmillButton.BackgroundColor3 = Color3.fromRGB(28, 29, 39)
        TreadmillStroke.Color = Color3.fromRGB(200, 200, 220)
    end
...
-- Checkbox stays ON (it shows your setting). Only the subtitle changes.
_G.YOKUDO_AutoTreadmill_OnPause = function()
    TreadmillSub.Text = "Paused — farming in progress"
end
...
-- ==================================================
local DisableWhenFarmHolder = Instance.new("Frame")
DisableWhenFarmHolder.Size = UDim2.new(1, 0, 0, 52)
DisableWhenFarmHolder.BackgroundTransparency = 1
DisableWhenFarmHolder.LayoutOrder = 5
DisableWhenFarmHolder.Parent = FarmingPage

local DisableWhenFarmLabel = Instance.new("TextLabel")
DisableWhenFarmLabel.Size = UDim2.new(1, -50, 0, 20)
DisableWhenFarmLabel.Position = UDim2.new(0, 0, 0, 2)
DisableWhenFarmLabel.BackgroundTransparency = 1
DisableWhenFarmLabel.Text = "Disable Treadmill When Farming"
DisableWhenFarmLabel.TextColor3 = Color3.fromRGB(255, 255, 255)
DisableWhenFarmLabel.TextSize = 13
DisableWhenFarmLabel.TextXAlignment = Enum.TextXAlignment.Left
DisableWhenFarmLabel.TextYAlignment = Enum.TextYAlignment.Center
DisableWhenFarmLabel.Font = Enum.Font.GothamBold
DisableWhenFarmLabel.Parent = DisableWhenFarmHolder

local DisableWhenFarmSub = Instance.new("TextLabel")
DisableWhenFarmSub.Size = UDim2.new(1, -50, 0, 18)
DisableWhenFarmSub.Position = UDim2.new(0, 0, 0, 24)
DisableWhenFarmSub.BackgroundTransparency = 1
DisableWhenFarmSub.Text = "Stop treadmill while egg farm is running"
DisableWhenFarmSub.TextColor3 = Color3.fromRGB(150, 150, 170)
DisableWhenFarmSub.TextSize = 10
DisableWhenFarmSub.TextXAlignment = Enum.TextXAlignment.Left
DisableWhenFarmSub.Font = Enum.Font.Gotham
DisableWhenFarmSub.Parent = DisableWhenFarmHolder

local DisableWhenFarmButton = Instance.new("TextButton")
DisableWhenFarmButton.Size = UDim2.new(0, 26, 0, 26)
DisableWhenFarmButton.Position = UDim2.new(1, -26, 0.5, -13)
DisableWhenFarmButton.BackgroundColor3 = Color3.fromRGB(28, 29, 39)
DisableWhenFarmButton.BorderSizePixel = 0
DisableWhenFarmButton.Text = ""
DisableWhenFarmButton.AutoButtonColor = false
DisableWhenFarmButton.Parent = DisableWhenFarmHolder

local DisableWhenFarmCorner = Instance.new("UICorner")
DisableWhenFarmCorner.CornerRadius = UDim.new(0, 6)
DisableWhenFarmCorner.Parent = DisableWhenFarmButton

local DisableWhenFarmStroke = Instance.new("UIStroke")
DisableWhenFarmStroke.Color = Color3.fromRGB(200, 200, 220)
DisableWhenFarmStroke.Thickness = 1.5
DisableWhenFarmStroke.Parent = DisableWhenFarmButton

local DisableWhenFarmCheck = Instance.new("TextLabel")
DisableWhenFarmCheck.Size = UDim2.new(1, 0, 1, 0)
DisableWhenFarmCheck.BackgroundTransparency = 1
DisableWhenFarmCheck.Text = "✓"
DisableWhenFarmCheck.TextColor3 = Color3.fromRGB(255, 255, 255)
DisableWhenFarmCheck.TextSize = 18
DisableWhenFarmCheck.Font = Enum.Font.GothamBold
DisableWhenFarmCheck.Visible = false
DisableWhenFarmCheck.Parent = DisableWhenFarmButton

local function SetDisableWhenFarmUI(state)
    DisableWhenFarmCheck.Visible = state
    if state then
...
DisableWhenFarmButton.MouseButton1Click:Connect(function()
    ...
    SetDisableWhenFarmUI(newState)
end)

-- Feature defaults to ON, so show the real state when the tab loads
task.spawn(function()
    task.wait(0.5)
    if _G.YOKUDO_AutoTreadmill then
        SetDisableWhenFarmUI(_G.YOKUDO_AutoTreadmill.GetDisableWhenFarming())
    end
end)
